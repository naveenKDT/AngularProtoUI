...
@Component({
                ...
                <div class="nav-children">
                  @for (child of item.children; track child.label) {
                    <a 
                      ...
                      [class.active]="activeRoute() === child.route"
                      [routerLink]="child.route"
                      (click)="navigate.emit(child.route!)"
                    >
  ...
  styles: [`
    .sidebar {
      ...
      height: 100vh;
      background: linear-gradient(180deg, var(--sidebar-gradient-start) 0%, var(--sidebar-gradient-mid) 50%, var(--sidebar-gradient-end) 100%);
      display: flex;
...
export class SidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    {
      icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M12 1v4m0 14v4M4.22 4.22l2.83 2.83m9.9 9.9l2.83 2.83M1 12h4m14 0h4M4.22 19.78l2.83-2.83m9.9-9.9l2.83-2.83"/></svg>',
    ...
    {
      icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/><path d="M8 14h.01M12 14h.01M16 14h.01M8 18h.01M12 18h.01"/></svg>',
      label: 'Leaves',
      route: '/leaves'
    },
    {
